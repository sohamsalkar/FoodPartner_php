...
<div class="col-md-12">
  <!-- <h4 class="page-header"><i class="fas fa-utensils"></i>&nbsp; Your Order Details for order no:<?php //echo $order_id 
                                                                                                      ?></h4><br /> -->
        ...
        <tbody>
          ...
          ?>
            ...
            <tr>
              ...
              <!-- <td align="right" class="text-success"><?php //echo $currency . ' ' . number_format($price, 2); 
                                                          ?></td>
                <td align="right" class="text-success"><?php //echo $currency . ' ' . number_format($total, 2); 
                                                        ?></td> -->
            </tr>
        <?php
          }
...
<script>
  function loadXMLDoc() {
    ...
    xhttp.open("GET", "./inc/status.php", true);
    xhttp.send();
  }
