...
$output = '';
//var_dump($_POST);
$orq=mysqli_query($conn,"SELECT * FROM `orders` WHERE order_id=$order_id");
$orderDetailsArray=mysqli_fetch_array($orq);
?>
<div class="col-md-12">
  <h4 class="page-header"><i class="fas fa-utensils"></i>&nbsp; Your Order Details for order no:<?php echo $orderDetailsArray['order_id'] ?></h4><br />
