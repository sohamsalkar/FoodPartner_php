  ...
  <div class="container">
   ...
   <ul class="nav navbar-nav">
    ...
    <ul class="nav navbar-nav navbar-right">
     ...
     <?php 
      if($_SESSION['current_order']!=null){
        echo '<li><a href="#" id="payment" class="btn btn-success ><i class="fas fa-utensils" style="color:white" ></i>CURRENT ORDER</a></li> ';
      }
     ?>
     
     <!-- <li><a href="inc/pay.php?oid=<?php //echo $_SESSION['order_id'];?>" id="payment"><i class="fas fa-utensils" ></i>PAY</a></li>  -->
